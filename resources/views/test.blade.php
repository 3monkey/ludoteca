...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <script src= {{ asset("assets/components/bootstrap/js/bootstrap.bundle.min.js") }}></script>
    <!-- Core plugin JavaScript-->
    <script src= {{ asset("assets/components/jquery/jquery-easing/jquery.easing.min.js") }}></script>
